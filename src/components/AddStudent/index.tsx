...
export default function Form() {
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto p-6 my-6 bg-white rounded-lg shadow-md">
            <div className="mb-4">
            ...
            <div className="mb-4">
                ...
                >
                    <p className="mb-2">Drag & Drop your <b className='text-red-600'>Resume</b> file here</p>
                    {formData.attachment && (
                        <div className="mt-4">
